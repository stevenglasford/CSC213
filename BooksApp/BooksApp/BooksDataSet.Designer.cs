...
namespace BooksApp.BooksDataSetTableAdapters {
    ...
    public partial class AuthorISBNTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::BooksApp.Properties.Settings.Default.BooksConnectionString;
        }
...
SELECT AuthorID, FirstName, LastName FROM Authors WHERE (AuthorID = @AuthorID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT        AuthorID, FirstName, LastName\r\nFROM            Authors\r\nWHERE      " +
                "  (LastName LIKE \'D%\')\r\nORDER BY LastName";
        ...
        public virtual int FillByLastName(BooksDataSet.AuthorsDataTable dataTable) {
        ...
        public virtual BooksDataSet.AuthorsDataTable GetDataBy() {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            BooksDataSet.AuthorsDataTable dataTable = new BooksDataSet.AuthorsDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
...
SELECT ISBN, Title, EditionNumber, Copyright FROM Titles WHERE (ISBN = @ISBN)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT ISBN, Title, EditionNumber, Copyright FROM dbo.Titles";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillBy(BooksDataSet.TitlesDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
